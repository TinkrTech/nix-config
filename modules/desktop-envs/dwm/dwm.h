/*
Jade's dwm build (based off of bread's dwm build)
...
static const char *fonts[]          = { "monospace:size=14", "Hack Nerd Font Mono:size=16", "NotoColorEmoji:pixelsize=14:antialias=true:autohint=true"  };
...
static const char *upvol[] 		= { "bash", "-c", "pamixer -i 5; pkill -RTMIN+10 dwmblocks",	NULL };
static const char *downvol[] 	= { "bash", "-c", "pamixer -d 5; pkill -RTMIN+10 dwmblocks", 	NULL };
static const char *mutevol[]	= { "bash", "-c", "pamixer -t; pkill -RTMIN+10 dwmblocks", 		NULL };
static const char *disable_screensaver[] = { "bash", "-c", "xset -dpms; xset s off; pkill -RTMIN+12 dwmblocks", NULL };
static const char *enable_screensaver[] = { "bash", "-c", "xset +dpms; xset s on; pkill -RTMIN+12 dwmblocks", NULL }; 
...
static const Key keys[] = {
	...
	// OS Management
	{ MODKEY,						XK_l,			spawn,		{.v = (const char*[]){ "betterlockscreen", "-l", NULL }}},	
